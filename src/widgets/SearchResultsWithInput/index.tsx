...
import { AccordionFacets, Pagination, Presence } from '@sitecore-search/ui';
...
export const SearchResultsWithInputComponent = ({
  ...
  const {
    ...
    // Filter by state = 'Abu Dabhi' as soon as the widget initializes.
    query.getRequest().addSearchFacetTypeFilter('state', 'facetid_eyJ0eXBlIjoiZXEiLCJuYW1lIjoic3RhdGUiLCJ2YWx1ZSI6IkFidSBEaGFiaSJ9');
    return {
...
const SearchResultsWithInputWidget = widget(SearchResultsWithInputComponent, WidgetDataType.SEARCH_RESULTS, 'content');
